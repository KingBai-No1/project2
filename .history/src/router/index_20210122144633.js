    ...
    routes:[
      {
        ...
        meta:{selected:"/"},
        children:[
          {path:"/home",component:()=>import("../components/home/index.vue"),meta:{selected:"/menu"},},
          ...
          /* 商品规格 */
          {path:"/specs",component:()=>import("../components/Specs/index.vue"),meta:{selected:"/specs"}},
          {path:"/specs/add",component:()=>import("../components/Specs/infor.vue"),meta:{selected:"/specs"}},
          {path:"/specs/:edit",component:()=>import("../components/Specs/infor.vue"),meta:{selected:"/specs"}},

          /* 商品管理 */
          {path:"/goods",component:()=>import("../components/Goods/index.vue"),meta:{selected:"/goods"}},
          {path:"/goods/add",component:()=>import("../components/Goods/infor.vue"),meta:{selected:"/goods"}},
          {path:"/goods/:edit",component:()=>import("../components/Goods/infor.vue"),meta:{selected:"/goods"}},
        ]
      },
      /* 登录页面 */
