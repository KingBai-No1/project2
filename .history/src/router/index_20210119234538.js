    ...
    routes:[
      {
        ...
        children:[
          ...
          /* 商品规格 */
          {path:"/spece",component:()=>import("../components/Spece/index.vue"),meta:{selected:"/spece"}},
          {path:"/spece/add",component:()=>import("../components/Spece/infor.vue"),meta:{selected:"/spece"}},
          {path:"/spece/:edit",component:()=>import("../components/Spece/infor.vue"),meta:{selected:"/spece"}}
        ]
      },
      /* 登录页面 */
