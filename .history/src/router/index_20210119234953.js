    ...
    routes:[
      {
        ...
        children:[
          ...
          /* 商品规格 */
          {path:"/specs",component:()=>import("../components/Cate/index.vue"),meta:{selected:"/cate"}},
          {path:"/specs/add",component:()=>import("../components/Cate/infor.vue"),meta:{selected:"/cate"}},
          {path:"/specs/:edit",component:()=>import("../components/Cate/infor.vue"),meta:{selected:"/cate"}}
        ]
      },
      /* 登录页面 */
