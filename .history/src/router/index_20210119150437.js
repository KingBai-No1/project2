    ...
    routes:[
      {
        ...
        children:[
          ...
          /* 商品管理 */
          {path:"/cate",component:()=>import("../components//index.vue"),meta:{selected:"/cate"}},
          {path:"/cate/add",component:()=>import("../components//infor.vue"),meta:{selected:"/cate"}},
          {path:"/cate/:edit",component:()=>import("../components//infor.vue"),meta:{selected:"/cate"}}
        ]
      },
      /* 登录页面 */
