    ...
    <div>
        ...
        <el-table :data="arr">
            ...
            <el-table-column label="操作">
                <template slot-scope="item"><el-button type="primary" size="mini">编辑</el-button>
                    <el-button type="danger" size="mini" @click="del(scope.index,scope.row)">删除</el-button></template>
