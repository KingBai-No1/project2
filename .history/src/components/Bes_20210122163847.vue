    ...
    <el-container class="box">
        ...
        <el-menu-item  style="text-align:center">
            <h3 style="color:white">
                <i class="el-icon-s-unfold" @click="changecss"></i>
            </h3>
        </el-menu-item>
        
        </el-menu>
            </el-aside>
            <el-main :style="changwidth">
                <router-view></router-view>
            </el-main>
        </el-container>    
        <el-footer style="height:30px">&copy;bxc版权所有</el-footer>
    </el-container>
</template>
...
export default {
    ...
    methods: {
        ...
        this.changewidth.width = {width:100%-64}
    }
    },
    watch:{
