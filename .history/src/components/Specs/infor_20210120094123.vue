...
<template>
    <div>
        ...
        <el-form label-width="80px" style="width:500px">
            ...
            <el-form-item label="规格属性" v-for="(item,index) in attrsArr" :key="index" v-mode>
                <div class="attrs">
                    <el-input v-model="infor.attrs"></el-input>
                    <el-button type="primary" style="margin-left:10px" @click="addAttr">添加属性</el-button>
                </div>
            </el-form-item>
            <el-form-item label="即时状态">
                <el-switch :active-color="1" :inactive-color="2" v-model="infor.status"></el-switch>
            </el-form-item>
            <el-form-item>
