    ...
    >
      ...
      <el-form-item label="商品规格">
        <el-select v-model="infor.specsid" @change="changeAttr">
          <el-option
            v-for="specsiditem in specsidarr"
            :key="specsiditem.id"
            :label="specsiditem.specsname"
            :value="specsiditem.id"
          ></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="规格属性">
        <el-select v-model="infor.specsattr" multiple>
          <el-option
            v-for="(specsattritem, index) in specsattrarr"
            :key="index"
            :label="specsattritem"
            :value="specsattritem"
          ></el-option>
          ...
          <div slot="file" slot-scope="{ file }">
            ...
            <span class="el-upload-list__item-actions">
              ...
              <span
                ...
                @click="handlePictureCardDel(file)"
              >
