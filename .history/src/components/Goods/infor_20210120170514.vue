    ...
    <div>
        ...
        <el-form label-width="80px" style="width:500px" :model="infor" :rules="rules" ref="goodsinfor">
            ...
            <el-form-item label="规格属性">
                <el-select v-model="infor.specsattr">
                    <el-option v-for="(specsattritem,index) in specsattrarr" :key="specsattritem.id" :label="specsattritem.goodsname" :value="specsattritem.id"></el-option>
                </el-select>
            </el-form-item>
        </el-form>
    </div>
