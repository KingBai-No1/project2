    ...
    <div>
        ...
        <el-form label-width="80px" style="width:500px" :model="infor" :rules="rules" ref="goodsinfor">
            ...
            <el-form-item label="规格属性">
                <el-select v-model="infor.specsid">
                    <el-option v-for="specsattritem in specsidarr" :key="specsattritem.id" :label="specsattritem.goodsname" :value="specsattritem.goodsname"></el-option>
                </el-select>
            </el-form-item>
        </el-form>
    </div>
...
export default {
    ...
    methods: {
        ...
        changeAttr(m){
            console.log(m);
            this,axios.get("/api/goodslist?pid="+m).then((res)=>{
                this.specsattrarr = res.data.list
            })
        }
    }
}
