        ...
        <el-form style="width:500px;" label-width="100px">
            <el-form-item  label="所属角色" prop="roleid"> 
                <el-select v-model="infor.roleid">
                    <el-option v-for="item in userarr" :key="item.uid" :label="item.username" value="username.i"></el-option>
                </el-select>
            </el-form-item>
...
export default {
    ...
    mounted(){
        /* 请求数据，得到前方数据 */
        axios.get("/api/userinfo",{params:{uid:this.$route.params.uid}}).then((res)=>{
            console.log(res);
